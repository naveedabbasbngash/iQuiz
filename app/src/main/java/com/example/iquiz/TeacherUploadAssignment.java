...
public class TeacherUploadAssignment extends AppCompatActivity implements View.OnClickListener {
    ...
    DatabaseReference dbref2 = db.child("Assigments").child("Teacher Uploaded");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnback = findViewById(R.id.teachback);
        ...
        dbref1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> spinAdapter1 = new ArrayAdapter<String>(TeacherUploadAssignment.this,android.R.layout.simple_list_item_1,mysubjects);
    ...
    public void onClick(View view) {
        ...
        else if(view.getId()==R.id.teachback)
        {
            finish();
        }
    }
    ...
    private void uploadFile() {
        ...
        if (filePath != null) {
            ...
            final StorageReference riversRef = storageReference.child("Assigments").child("Teacher Uploaded")
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            riversRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    //AssignmentModel upload = new AssignmentModel(fullname, uri.toString());
                                    AssignmentModelTeacher upload = new AssignmentModelTeacher(fullname, uri.toString());
                                    ...
                                    dbref2.child(mykey).setValue(upload).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            Toast.makeText(TeacherUploadAssignment.this, "Assigment has been Uploaded", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                    assignment.setText("");
                                    txtStatus.setText("");
